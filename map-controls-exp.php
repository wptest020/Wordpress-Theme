...
<div  class="map-arrows-actions">
    <button id="experience-mapzoomin" class="map-btn"><i class="homey-icon homey-icon-add"></i> </button>
    <button id="experience-mapzoomout" class="map-btn"><i class="homey-icon homey-icon-subtract"></i></button>
