    ...
    <div class="container">
        <div class="row">
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div class="listing-wrap which-layout-<?php echo $taxonomy_layout;?> <?php if(str_contains($taxonomy_layout, '2')){ echo 'item-'.grid_list_or_card($taxonomy_layout, 1).'-view'; } ?> item-view-<?php echo esc_attr($taxonomy_layout);?>">
                    <div class="row">
                        <?php
