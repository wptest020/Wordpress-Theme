               		...
               		?>
		                     ...
		                     <div class="cape-subpages-main-inner repeater-item" data-index="<?= $count; ?>">
		                        <div class="cape-sideimg">
		                           <img src="<?= get_sub_field('images');?>" class="img-fluid">
		                        </div>
		                        <div class="cape-side-content">
		                           <h3><?= get_sub_field('title');?></h3>
		                           <a href="<?= get_sub_field('link');?>" target="_blank">Visit website</a>
		                           <p><?= get_sub_field('contents');?></p>
		                        </div>
		                     </div>
                <?php 
                $count++;
